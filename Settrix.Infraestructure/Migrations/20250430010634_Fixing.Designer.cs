...
namespace Settrix.Infraestructure.Migrations
{
    ...
    [Migration("20250430010634_Fixing")]
            ...
            modelBuilder.Entity("Settrix.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CompanyId = 1L,
                            CreatedAt = new DateTime(2025, 4, 30, 1, 6, 33, 737, DateTimeKind.Utc).AddTicks(7933),
                            CreatedBy = 1L,
                            Email = "",
                            IsActive = true,
                            Name = "Bill Gatos",
                            Password = "",
                            Role = 0,
                            SecurityId = new Guid("aaa9640a-2413-4211-b1ea-516f9f95bef1")
                        });
                });
